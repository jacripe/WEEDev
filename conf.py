...
BLOG_TITLE = "WEEDev"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://dev.wiseeyesent.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://dev.wiseeyesent.com/"
BLOG_EMAIL = "admin@wiseeyesent.com"
BLOG_DESCRIPTION = "WiseEyes Enterprise Research Laboratories"  # (translatable)
